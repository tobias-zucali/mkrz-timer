---
title: Impressum
description: Legal disclosure and contact information for mkrz timer.
---
...
Responsible for the website and project content:
...
The hosted infrastructure is currently operated within the European Union. The server infrastructure is hosted in Frankfurt, Germany.

## Applicable law

The project and hosted service are intended to operate under applicable Austrian and European Union law, including GDPR/DSGVO requirements where applicable.

## Liability for links

This website may contain links to external websites operated by third parties. No responsibility is taken for the contents of linked external pages.

## Copyright and licensing

Unless stated otherwise, the contents and source code of this project are subject to the applicable copyright and license terms defined in the repository and LICENSE file.
...
## Template and legal orientation

This page was created with reference to publicly available Austrian Impressum requirements and explanatory resources, including:

- [Wikipedia: Impressum](https://de.wikipedia.org/wiki/Impressum)
