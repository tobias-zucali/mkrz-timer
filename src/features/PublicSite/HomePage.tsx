    ...
    <PublicPageFrame currentSlug="home" locale={locale}>
      ...
      >
        <div
          ...
          "
        />
        <div className="px-6 py-2 text-ink sm:px-8 sm:py-4">
          <h1 className="max-w-3xl text-5xl font-semibold tracking-tight text-ink sm:text-6xl">
            {content.title}
          </h1>
          <div className="mt-6 max-w-3xl text-lg/8 text-ink/86">
        ...
        >
          <div className="border-t border-white/10 py-6 first:border-t-0 lg:py-7">
            ...
            <p className="mt-3 text-sm/7 text-ink/72">
              {PublicSite.home.localTimerDescription}
            </p>
            <Link
              className="mt-6 inline-flex rounded-full border border-primary/35 bg-primary/90 px-5 py-3 text-sm font-semibold text-white transition hover:bg-primary focus:outline-2 focus:-outline-offset-2 focus:outline-primary"
              href={`/${locale}/t`}
            >
          ...
          <div className="border-t border-white/10 py-6 lg:py-7">
            ...
            <Link
              className="mt-6 inline-flex rounded-full border border-white/14 px-5 py-3 text-sm font-semibold text-ink transition hover:border-primary/45 hover:text-primary focus:outline-2 focus:-outline-offset-2 focus:outline-primary"
              href={`/${locale}/t#share`}
            >
