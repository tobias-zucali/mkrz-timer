...
const SESSION_DIR_NAME = ".prototype-sessions"
...
function sessionRoot(repo) {
  return path.join(path.resolve(repo), SESSION_DIR_NAME)
}
...
function printHelp() {
  const scriptName = path.basename(process.argv[1] || "prototype_session.mjs")
